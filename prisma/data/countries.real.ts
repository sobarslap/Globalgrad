...
export const realCountries: RealCountry[] = [
  ...
  { name: "Sweden", code: "SE", flagEmoji: "🇸🇪", postStudyWorkMonths: 12, monthlyLivingCostUsd: 1000, costOfLivingIndex: 74, partTimeAllowed: true, workHoursPerWeek: 15, currency: "SEK", latitude: 60.1, longitude: 18.6 },
